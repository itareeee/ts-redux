...
/***/ function(module, exports, __webpack_require__) {
	...
	const Redux = __webpack_require__(166);
	...
	(function (CounterActionTypes) {
	    CounterActionTypes[CounterActionTypes["Increment"] = 0] = "Increment";
	    CounterActionTypes[CounterActionTypes["Decrement"] = 1] = "Decrement";
	})(CounterActionTypes || (CounterActionTypes = {}));
	function increment() { return { type: CounterActionTypes.Increment }; }
	function decrement() { return { type: CounterActionTypes.Decrement }; }
	function counter(state = new Counter(0), action) {
	    switch (action.type) {
	...
	class App extends React.Component {
	    render() {
	        ...
	        return (React.createElement("div", null, 
	            ...
	            React.createElement("button", {onClick: () => dispatch(increment())}, "Inc"), 
	            React.createElement("button", {onClick: () => dispatch(decrement())}, "Dec")));
	    }
	}
	const ReduxCounterApp = react_redux_1.connect((state) => ({ counter: state.counter }))(App);
	ReactDOM.render(React.createElement(react_redux_1.Provider, {store: store}, 
	    React.createElement(ReduxCounterApp, null)
	), document.body);
