...
/***/ function(module, exports, __webpack_require__) {
	...
	const redux_1 = __webpack_require__(166);
	const react_redux_1 = __webpack_require__(179);
	const react_router_1 = __webpack_require__(192);
	const react_router_redux_1 = __webpack_require__(251);
	...
	class App extends React.Component {
	    render() {
	        return (React.createElement("div", null, 
	            ...
	            React.createElement(react_router_1.Link, {to: "foo"}, "Foo"), 
	            React.createElement("br", null), 
	            React.createElement(react_router_1.Link, {to: "bar"}, "Bar"), 
	...
	class BarChild extends React.Component {
	    render() {
	        return (React.createElement("b", null, 
	            "BarId: ", 
	...
	class FirstPane extends React.Component {
	    render() {
	        const style = { width: "200px", height: '800px', backgroundColor: 'red' };
	...
	ReactDOM.render(React.createElement(react_redux_1.Provider, {store: store}, 
	    React.createElement(react_router_1.Router, {history: history}, 
	        React.createElement(react_router_1.Route, {path: "/", component: FirstPane}, 
	            React.createElement(react_router_1.IndexRoute, {component: App}, 
	                React.createElement(react_router_1.Route, {path: "foo", component: Foo}, 
	                    React.createElement(react_router_1.Route, {path: "/foochild/:fooId", component: FooChild})
	                ), 
	                React.createElement(react_router_1.Route, {path: "bar", component: Bar}), 
	                React.createElement(react_router_1.Route, {path: "/bar/:barId", component: BarChild}))
	        )
	    )
	), document.body);
